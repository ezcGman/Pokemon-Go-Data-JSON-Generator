    ...
    def parseJson(self):
        ...
        for i in itemTemplates:
            ...
            # Find new templates
                ...
                if not any(z in ['backgroundModeSettings', 'battleSettings', 'combatLeagueSettings', 'combatSettings', 'combatStatStageSettings', 'encounterSettings', 'gymBadgeSettings', 'gymLevel', 'iapSettings', 'luckyPokemonSettings', 'playerLevel', 'pokecoinPurchaseDisplayGmt', 'pokemonUpgrades', 'combatNpcPersonality', 'weatherBonusSettings', 'adventureSyncV2Gmt', 'moveSequenceSettings', 'buddyEncounterCameoSettings', 'buddyHungerSettings', 'buddySwapSettings', 'buddyWalkSettings', 'invasionNpcDisplaySettings', 'combatCompetitiveSeasonSettings', 'combatRankingProtoSettings', 'pokestopInvasionAvailabilitySettings', 'limitedPurchaseSkuSettings', 'platypusRolloutSettings', 'vsSeekerClientSettings', 'raidSettings', 'avatarGroupOrderSettings'] for z in i):
